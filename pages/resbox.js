...
const getFood = () => {
    onSnapshot(
        query(collection(db, "food")), (snapshot) => {
            setFood(snapshot.docs)
...
const getQuestion = () => {
    onSnapshot(
        query(collection(db, "Question")), (snapshot) => {
...
const getResturants = () => {
    onSnapshot(
        query(collection(db, "food"), where("id", "==", selectResturant.id)), (snapshot) => {
            setFood(snapshot.docs)
            console.log(snapshot.docs);
        })
};
                ...
                <div className="row">
                    <div className="col-lg-8 col-sm-12">
                        ...
                        <div className={resstyle.text_section_res_box}>
                            ...
                            count={5}
                            size={24}
                            value={selectResturant.data().rating}
                            color2={'#ffd700'} />
                            <br />
                            <br />
